    ...
    <div className="flex items-center justify-center p-4 h-[65vh] sm:mt-0 mt-8">
      ...
      >
        ...
        <div className="flex-1 text-center sm:text-left">
          <h1 className="text-3xl sm:text-4xl text-gray-800 tracking-tight">
            The simplest way to find accurate weather.
          </h1>
          <p
            style={{ fontFamily: "'Poppins', sans-serif" }}
            className="text-4xl sm:text-5xl font-extrabold text-orange-500 mt-4"
          >
            WeatherNow.
          </p>
          <div className="flex flex-col sm:flex-row justify-start space-y-3 sm:space-y-0 sm:space-x-4 mt-6">
            <Link
              to="/login"
        ...
        <div className="flex-1 flex justify-end">
          <img
            src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExYTJvZHQyM2swdzZ5N2JqZDBjYTZua2s5aXJnbnF1bTBzeGxibWwwdSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/glZnJBORLkOk1cFFNQ/giphy.gif"
            alt="Weather Sunrays GIF"
